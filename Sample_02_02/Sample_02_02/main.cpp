...
struct SimpleVertex
{
	float pos[3];       // 頂点座標 // ４にしたらカラーコード一つずれた
	float color[3];     // 頂点カラー
};
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	SimpleVertex vertices[] = {
		...
		},
		{
			...
			{ 0.5f, 0.5f, 0.5f }
				...
				{
			{-0.3f, -0.5f, 0.0f},// 左下 10
			{ 1.0f, 0.0f, 0.0f}//　色
		},
		{
			{ -0.5f, 0.3f, 0.0f},//　左上 11
			{ 1.0f, 0.0f, 0.0f }
		},
		{
			{ 0.5f, 0.3f, 0.0f},//　右上 12
			{ 0.0f, 1.0f, 0.0f}
		},
		{
			{ 0.3f, -0.5f, 0.0f},//　右下 13
			{ 0.0f, 1.0f,0.0f}
		},
		{
			{ 0.0f, 0.8f, 0.0f},//　上 14
	...
	//インデックス配列
	uint16_t indices[] = {
		0,1,2,0,2,3,1,2,4//,5,6,7,5,7,8,5,6,8,9,10,11,9,11,12,
	};
	...
	while (DispatchWindowMessage())
	{
		...
		// 6. ドローコール
		renderContext.DrawIndexed(9);//　頂点数の指定
